		...
		<!-- sidebar menu -->
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				...
				<li><a><i class="fa fa-bar-chart-o"></i> Exhibitions <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="content.php?sk=new_exhibution">New Exhibitions</a></li>
                      <li><a href="content.php?sk=new_exhibutionDetails">New Exhibitions Details</a></li>
