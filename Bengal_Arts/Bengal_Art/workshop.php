...
<!-- page content -->
            ...
            <div class="page-title">
              <div class="title_left">
                <h3>Programmes of Bengal Foundation</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" action="workshop_action.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="Catagories" class="form-control" name="catagories" required="required">
                            ...
                            <option value="Practice Studio">Practice Studio</option>
                            <option value="Event">Event</option>
                            <option value="Grant & Award">Grant & Award</option>
                            <option value="Residency">Residency</option>
                            <option value="Partnership Project">Partnership Project</option>
                          </select>
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="workshop_name">Programmes Name  <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="workshop_name" name="workshop_name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="conducted_name" name="conducted_name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="short_dip" name="short_dip" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="v_link">Video link  </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="v_link" name="v_link" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  
					  <div class="form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="workshop_details"> Programmes Details<span class="required">*</span>
                        </label>
						<div class="col-md-10 col-sm-10 col-xs-12">
							<textarea id="workshop_details" rows="10" name="workshop_details" class="resizable_textarea form-control ckeditor" placeholder="write down your Company information & must be followed categories.." required="required"></textarea>
						</div>
                      </div>
