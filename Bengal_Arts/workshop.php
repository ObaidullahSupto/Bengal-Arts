...
<div class="custom_container">
  <div class="row">
    ...
    <section id="pinBoot">
								...
								$total_results = mysqli_num_rows(mysqli_query($con,"SELECT * FROM workshop where catagories = 'Workshop'"));

			
								$total_pages = ceil($total_results / $max_results);
								$query=mysqli_query($con,"SELECT * FROM workshop where catagories = 'Workshop' order by id DESC LIMIT $from,$max_results");
